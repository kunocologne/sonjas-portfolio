...
> = ({ className, headline, subline, buttonText, buttonLink }) => {
  return (
    <section className={cn('relative bg-white pt-24 pb-16 md:pt-28 md:pb-20 lg:pt-32 lg:pb-24 overflow-hidden min-h-screen flex items-center', className)}>
      ...
      <div className="relative container mx-auto px-6 lg:px-16 w-full">
        {/* Mobile Layout: Stack everything vertically and centered */}
        <div className="lg:hidden flex flex-col items-center text-center space-y-6 max-w-md mx-auto">
          ...
          <div className="relative w-64 h-64 sm:w-72 sm:h-72">
            ...
            <div className="absolute -bottom-2 -right-2">
              <div className="relative bg-white border-2 border-brand-neutral rounded-xl shadow-lg p-3">
                <div className="text-center">
                  <div className="text-xl font-bold text-brand-dark leading-none">10+</div>
                  <div className="text-xs font-semibold text-brand-text/60">Jahre</div>
                </div>
              </div>
            </div>

            {/* Certification badge */}
            <div className="absolute -top-2 -left-2 w-12 h-12 bg-white border-2 border-brand-neutral rounded-full shadow-lg flex items-center justify-center">
              <svg className="w-6 h-6 text-brand-text/70" fill="currentColor" viewBox="0 0 20 20">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-brand-dark hover:bg-brand-text text-white rounded-full font-semibold text-base transition-all duration-300 shadow-md hover:shadow-xl w-full sm:w-auto"
          >
            {buttonText}
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-brand-text/60 pt-2">
        ...
        {/* Desktop Layout: Keep side by side */}
        <div className="hidden lg:grid lg:grid-cols-12 gap-12 items-center">
          {/* Left - Content */}
          <div className="lg:col-span-7 space-y-7">
            {/* Badge */}
